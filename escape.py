...
# Scenery describes objaect that cannot move between rooms.
...
for room in range(1, 26): # random planet sceney locations
    if room != 13: # skip this room!
...
def draw():
    ...
    for y in range(room_height):
        for x in range(room_width):
            ...
            if hazard_here != 0: # If hazard is at position
